...
if [ "conf_cpu_volt" == "$1" ]; then
	...
	if [ "undervolt light" == "$2" ]; then
		echo "0;0;0;0;0;0;-25;-25;-25;-25;-25;-50;-50;-50;-50;-50"
	fi
	if [ "undervolt medium" == "$2" ]; then
		echo "-25;-25;-25;-25;-25;-25;-25;-25;-25;-25;-50;-50;-50;-50;-50;-75;-75;-75;-75;-75"
	fi
	if [ "undervolt heavy" == "$2" ]; then
		echo "-50;-50;-50;-50;-50;-50;-50;-50;-50;-50;-75;-75;-75;-75;-75;-100;-100;-100;-100;-100"
	fi
	exit 0
fi
